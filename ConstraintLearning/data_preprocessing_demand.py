...
if __name__ == "__main__":
    ...
    X["is_holiday_pm1"] = X["service_date"].apply(
        lambda d: is_holiday_pm1(d, es_holidays)
    )
    X["is_holiday_madrid_pm1"] = X["service_date"].apply(
        lambda d: is_holiday_pm1(d, es_holidays_madrid)
    )
    X["is_holiday_catalonia_pm1"] = X["service_date"].apply(
        lambda d: is_holiday_pm1(d, es_holidays_catalonia)
    )
