...
results_files = os.listdir(model_subpath)
for day in days_to_test:
    ...
    df = pd.read_csv(os.path.join(model_subpath, best_file))
    df['day'] = day
...
robin_output_path = os.path.join(path_kernel_output, model_subpath, 'kernel_output.csv')
...
output_agg_path = os.path.join(path_validation_results, f"{model_name}.csv")
...
renfe_revenue_path = os.path.join(path_validation_results, f"{model_name}_renfe_revenue.csv")
